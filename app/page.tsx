...
export default async function Home() {
  ...
  const languageData = await getGitHubLanguageStats();
          ...
          <div className="row align-items-center g-4">
            <div className="col-lg-8">
              ...
              <h1 className="display-5 fw-bold mb-3">
                Building systems from the microscopic details to the high-level patterns.
              </h1>
            ...
            <div className="col-lg-4">
              <div className="row row-cards">
                ...
                <div className="col-12">
                  {/* Pass the GitHubLanguageAnalysis object to data */}
                  <LanguagePanel data={languageData} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="d-flex align-items-center justify-content-between mb-3">
            <div>
              ...
              <div className="text-secondary">
                The projects I&apos;m currently working on or the projects I liked the most.
              </div>
            </div>
